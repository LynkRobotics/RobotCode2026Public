...
public class COTSTalonFXSwerveConstants {
    ...
    public static final class SDS {
        ...
        public static final class MK5n {
            ...
            public static final COTSTalonFXSwerveConstants KrakenX60X44(double driveGearRatio){
                double wheelDiameter = Units.inchesToMeters(4.0);
            ...
            public static final class driveRatios {
                public static final double R1 = (54.0 / 12.0) * (25.0 / 32.0) * (30.0 / 15.0);
                public static final double R2 = (54.0 / 14.0) * (25.0 / 32.0) * (30.0 / 15.0);
                public static final double R3 = (54.0 / 16.0) * (25.0 / 32.0) * (30.0 / 15.0);
            }
        }
    }
}